...
function PastEvents(props) {
    ...
    async function fetchAllEvents() {
        ...
        for (const e of data) {
            ...
            const eventDetail = [event.eventName, event.eventId, event.eventHolderId, event.eventType, event.eventLocation, event.eventThumbnail, event.eventStartDate.slice(0, 10), event.eventTicketPrice, event.eventStartDate];
