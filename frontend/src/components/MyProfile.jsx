    ...
    const fetchData = async () => {
      ...
      if (response.ok) {
        ...
        for (const id of followedIds) {
          const response = await fetch(`http://localhost:8090/user/query/${id}`);
      ...
      <>
        <div style={styles.gridContainer}>
          ...
          <div style={styles.secondaryContent}>
            ...
            <p style={styles.paraStyle}>You have published <span style={{color:'#E4470E', fontSize: '20px'}}>{user.userHoldActivityList.split(',').length}</span> events</p>
            <br />
