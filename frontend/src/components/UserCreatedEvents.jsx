...
import {Button, Card, Image, Modal, notification, Pagination, Select, Tag} from 'antd';
...
function UserCreatedEvents() {
    ...
    useEffect(() => {
        switch (filter) {
            case 'past':
                setFilteredEvents(events.filter(event => new Date(event.eventEndDate) < new Date()));
                break;
            case 'upcoming':
                setFilteredEvents(events.filter(event => new Date(event.eventEndDate) >= new Date()));
                break;
                        ...
                        {eventsToDisplay.map((event, index) => {
                            ...
                            return (
                                <Card
                                    ...
                                    cover={<Image
                                        className={new Date(event.eventEndDate) < new Date() ? 'past-event' : ''}
                                        src={imageSource}/>}
                                >
                                    ...
                                    <div>
                                        ...
                                        <Button danger onClick={() => cancelButton(event.eventId)}>Cancel</Button>
                                    </div>
                                </Card>
                            );
                        })}
